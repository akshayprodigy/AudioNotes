...
class RecordTileService : TileService(), CaptureListener {
  ...
  private fun render() {
    ...
    tile.label = getString(com.innocorelabs.verbale.R.string.tile_label)
    tile.icon = Icon.createWithResource(this, com.innocorelabs.verbale.R.drawable.ic_notification_rec)
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
      tile.subtitle = when {
        stopping -> getString(com.innocorelabs.verbale.R.string.tile_finishing)
        CaptureController.paused -> getString(com.innocorelabs.verbale.R.string.tile_paused)
        recording -> getString(com.innocorelabs.verbale.R.string.tile_recording)
        else -> getString(com.innocorelabs.verbale.R.string.tile_idle)
      }
    }
    tile.updateTile()
  }
