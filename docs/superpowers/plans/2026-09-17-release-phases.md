...
| 5 | **Custom vocabulary + dictation** (sub-project 8). Vocabulary as correction rules applied after recognition ("in over" → "Innova"; a recogniser prompt was measured and rejected — it drops words on every meeting); rules learned from "Correct the words" or typed in Settings; Pro. Dictation mode: one voice, spoken punctuation, the note as the write-up, the transcript as the verbatim view. Design: `docs/superpowers/specs/2026-09-18-phase-5-vocabulary-and-dictation-design.md`; Session 1 sheet `2026-09-18-phase-5-session-1-execution.md`; Session 2 sheet `2026-09-21-phase-5-session-2-execution.md`; Session 3 (device) sheet `2026-09-21-phase-5-session-3-device-execution.md`. | **Built, awaiting the phone** — C++ done (`9f05928`); Session 1 (native + data) and Session 2 (screens) built and reviewed 21 Sep, gate clear; Session 3 = Session 1's Step 7 on the Pixel (VocabularyDbTest is written and compiles; ~30 steps once the phone is attached); then the founder's by-hand run (report §7) |
