...
| 5 | **Custom vocabulary + dictation** (sub-project 8). A local glossary biasing the recogniser and the narrator; corrections feed it; a separate dictation mode (one voice, no diarization, punctuation commands). | Next |
